            ...
            modelBuilder.Entity("OrderService.WebAPI.Domain.OrderItem", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("BoxSize", "OrderService.WebAPI.Domain.OrderItem.BoxSize#OrderItemBoxSize", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Period", "OrderService.WebAPI.Domain.OrderItem.Period#OrderItemPeriod", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Quantity", "OrderService.WebAPI.Domain.OrderItem.Quantity#OrderItemQuantity", b1 =>
                        {
                            b1.IsRequired();
