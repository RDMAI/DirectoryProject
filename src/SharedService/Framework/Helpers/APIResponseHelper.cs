...
{
    public static IActionResult ToAPIResponse<T>(Result<T> result)
    {
        if (result.IsSuccess)
    ...
    public static IActionResult ToAPIResponse(UnitResult result)
    {
        if (result.IsSuccess)
    ...
    public static IActionResult Error(Error error) => Error([error]);

    public static IActionResult Error(List<Error>? errors)
    {
